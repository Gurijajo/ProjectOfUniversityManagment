                     ...
                     <div class="form-group">
                      <label>Subject Name</label>
                            ...
                            <label style="font-weight: normal;">
                              <input type="checkbox" value="7" name="subject_id[]"> AGRIC SCIENCE
                            </label>
                            </div>
                                                  <div>
                            <label style="font-weight: normal;">
                              <input type="checkbox" value="4" name="subject_id[]"> BASIC SCIENCE AND TECHNOLOGY
                            </label>
                            </div>
                                                  <div>
                            <label style="font-weight: normal;">
                              <input type="checkbox" value="6" name="subject_id[]"> BASIC TECHNOLOGY
                            </label>
                            </div>
                                                  <div>
                            <label style="font-weight: normal;">
                              <input type="checkbox" value="2" name="subject_id[]"> ENGLISH LANGUAGE
                            </label>
                            </div>
                                                  <div>
                            <label style="font-weight: normal;">
                              <input type="checkbox" value="5" name="subject_id[]"> HOME ECONOMICS
                            </label>
                            </div>
                                                  <div>
                            <label style="font-weight: normal;">
